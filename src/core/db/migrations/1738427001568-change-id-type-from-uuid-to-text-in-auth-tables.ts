...
export class ChangeIdTypeFromUuidToTextInAuthTables1738427001568
  implements MigrationInterface
{
  name = 'ChangeIdTypeFromUuidToTextInAuthTables1738427001568';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "two_factor" DROP CONSTRAINT "REL_162c7f53b41b84102a8e06eff1"`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "two_factor" ADD CONSTRAINT "REL_162c7f53b41b84102a8e06eff1" UNIQUE ("user_id")`,
    );
    await queryRunner.query(
      `ALTER TABLE "two_factor" DROP CONSTRAINT "PK_d9e707ebc943c110fcaab7cdd8c"`,
    );
